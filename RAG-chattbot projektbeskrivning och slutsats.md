...
**Använding i verkligheten**

I More Sailings verksamhet som består av ca 150 säsongsarbetare varje år finns ett stort behov av att på ett enkelt sätt komma åt E-learningen inte bara för att utbilda ny personal utan också som stöd för återkommande personal för att kunna ställa konkreta frågor kring exempelvis rutiner, gästfrågor eller säkerhet. Detta är idag något som tar tid och upplevs krångligt vilket ofta leder till att man frågar någon som kanske har sin egna uppfattning eller "killgissar". Detta leder till förvirring och olika sätt att arbeta på i en organisation där det annars finns tydliga riktlinjer. Dessa problem har en RAG-chattbot stor potential att förbättra.

Samtidigt finns viktiga begränsingar, En risk är att användare litar för mycket på svaren, trotts att modellen kan ge felaktiga svar exempelvis om fel kontext hämtas, svaret påverkas av brus eller användaren formulerar frågan konstigt.

För att fungera bra i praktiken hade det därför krävts bättre kontroll över datakvalitet, tydliga begränsingar i användning och en arkitektur med uppdatering av data och anpassning för olika frågetyper.

Ur ett etiskt perspektiv är det också viktigt att användaren förstår att modellen kan ge felaktiga svar och att den självklart inte ersätter eget ansvar eller omdöme, speciellt i situationer gällande säkerhet och ansvar gällande både båt och gäster.

Tänker man ur ett affärsperspektiv som efterfrågades så behöver man nog fundera över utvecklings och driftkostnader mot faktiskt nytta. 
